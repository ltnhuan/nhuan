...
<template>
  <EraLmsLayout :session-user="sessionUser">
    <template #breadcrumb>Điểm danh online / Teacher board</template>
    <section class="border-b bg-white">
      <div class="mx-auto max-w-7xl px-4 py-5 sm:px-6">
        <div class="flex flex-wrap items-center justify-between gap-3">
          <div><h1 class="text-lg font-semibold">Teacher Attendance Board</h1><p class="mt-1 text-sm text-slate-600">Theo dõi phiên điểm danh, trạng thái khóa và số bản ghi đã nhận.</p></div>
    ...
    <section class="mx-auto max-w-7xl px-4 py-5 sm:px-6">
      ...
      <div class="overflow-hidden border bg-white">
        <table class="w-full text-left text-sm">
          <thead class="bg-slate-50 text-xs uppercase text-slate-500"><tr><th class="px-4 py-3">Phiên</th><th class="px-4 py-3">Course</th><th class="px-4 py-3">Method</th><th class="px-4 py-3">Open</th><th class="px-4 py-3">Status</th><th class="px-4 py-3">Records</th></tr></thead>
