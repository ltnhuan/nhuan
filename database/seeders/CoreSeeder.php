...
class CoreSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($roles as $name => $display) {
            ...
            $allowed = $name === 'student' ? ['course.view','progress.view_own','video.view','exam.attempt','exam.result.view','assignment.view','assignment.submit','gradebook.view','attendance.checkin','eligibility.view','enrollment.self','analytics.dashboard','career.view','career.manage_own','portfolio.manage_own','skill.manage','competency.manage','credential.view','credential.wallet','ai.use','community.view','community.post','community.wiki','community.blog','community.group','community.reputation','survey.view','survey.respond'] : $permissions;
